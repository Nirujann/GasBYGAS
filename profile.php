                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" class="form-control" placeholder="Type here...">
                        </div>
                    </div>
                            ...
                            <form action="update_profile.php" method="POST" class="profile-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php echo htmlspecialchars($user['nic']); ?>" readonly>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="change-password-section">
                                ...
                                <form action="update_password.php" method="POST" class="password-form">
                                    ...
                                    <button type="submit" class="btn btn-primary mt-7">Change Password</button>
                                </form>
                            </div>
                        </div>
                    </div>
